...
const faqItems: FAQItem[] = [
  {
    ...
    answer: 'はい。昼食さんは無料で提供しており、課金プランや追加料金はありません。'
  },
  {
    question: '会員登録は必要ですか?',
    answer: '不要です。名前とメールアドレスを入力するだけでイベントの作成や参加ができます。'
  },
  {
    question: 'URLは何度でも使えますか?',
    answer: 'はい。同じURLで参加状況の更新や投票ができ、毎日0時に回答だけ自動でリセットされます。常連メンバーとの調整にも便利です。'
  },
  {
    question: '他のサービスと何が違うの?',
    answer: '昼食さんはランチ調整に特化しており、URL共有型の気軽さのまま候補のお店検索や投票まで一画面で完結します。'
  },
  {
    question: '使い方を知りたいです。',
    answer: 'トップページの「使い方を見る」から3ステップのガイドをご覧いただけます。動画やマニュアルは不要です。'
  },
  {
    question: '位置情報は必須ですか?',
    answer: 'いいえ。位置情報を許可しなくても店名やエリアで検索できます。許可すると近くのお店が自動で出るので、よりスムーズです。'
  },
  {
    question: '参加者の情報はどこまで見えますか?',
    answer: '表示されるのは名前だけです。メールアドレスやパスワードは他の参加者には共有されません。'
  },
  {
    question: 'URLを忘れた場合は?',
    answer: '作成時に使ったメールアドレスとパスワードを入力すると、最近のイベントURLを検索できます。FAQの「URLを忘れた場合」からお試しください。'
  },
  {
    question: 'パスワードを忘れた場合は?',
    answer: 'セキュリティ上、パスワードの再発行は行っていません。編集が必要な場合は新しいイベントを作成してください。既存URLでの閲覧や参加は引き続き可能です。'
  }
]
