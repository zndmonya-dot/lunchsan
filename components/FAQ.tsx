...
const faqItems: FAQItem[] = [
  {
    ...
    answer: 'はい、完全無料です。課金プランや追加料金は一切ありません。'
  },
  {
    question: '会員登録は必要ですか?',
    answer: '不要です。名前とメールアドレスを入力するだけで、すぐに始められます。'
  },
  {
    question: 'URLは何度でも使えますか?',
    answer: 'はい。同じURLで参加状況の更新や投票ができます。毎日0時に回答だけリセットされるので、常連メンバーとの調整にも便利です。'
  },
  {
    question: '他のサービスと何が違うの?',
    answer: '昼食さんはランチ調整に特化しています。URL共有型の気軽さはそのまま、お店探しから投票まで一画面で楽しめます。'
  },
  {
    question: '使い方を知りたいです。',
    answer: 'トップページの「使い方を見る」から3ステップのガイドをご覧いただけます。すぐに使い始められますよ。'
  },
  {
    question: '位置情報は必須ですか?',
    answer: 'いいえ。位置情報を許可しなくても、店名やエリアで検索できます。許可すると近くのお店が自動で出るので、よりスムーズです。'
  },
  {
    question: '参加者の情報はどこまで見えますか?',
    answer: '表示されるのは名前だけです。メールアドレスやパスワードは他の参加者には見えません。'
  },
  {
    question: 'URLを忘れた場合は?',
    answer: '作成時に使ったメールアドレスとパスワードを入力すると、最近のイベントURLを探せます。FAQの「URLを忘れた場合」からお試しください。'
  },
  {
    question: 'パスワードを忘れた場合は?',
    answer: 'セキュリティ上、パスワードの再発行は行っていません。編集が必要な場合は新しいイベントを作成してください。既存URLでの閲覧や参加は引き続きできます。'
  }
]
